                      ...
                      <img
                        ...
                        onError={(e) => {
                          ...
                          if (parent) {
                            ...
                            fallback.className =
                              'w-28 h-28 sm:w-24 sm:h-24 rounded-full bg-primary/10 dark:bg-primary/20 flex items-center justify-center border-4 border-primary shadow-lg';
                            fallback.innerHTML =
                              '<svg class="w-14 h-14 sm:w-12 sm:h-12 text-primary" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd" /></svg>';
