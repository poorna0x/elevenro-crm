...
function PayBrandMark({ brand }: { brand: DocumentBrand }) {
  ...
  return (
    <div className="flex items-center justify-center gap-2">
      <div className="relative z-10 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-primary shadow-sm">
...
const PayUpi = () => {
  ...
  const brand: DocumentBrand = normalizeDocumentBrand(params.get('brand')) || 'elevenro';
