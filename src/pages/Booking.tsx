            ...
            >
              <div className="flex items-start gap-3">
                ...
                <label htmlFor="booking-legal-consent" className="text-sm text-muted-foreground leading-snug cursor-pointer">
                  ...
                  . I consent to Eleven RO using my contact details to arrange and perform this service, including
      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 sm:px-6 pt-6 sm:pt-10 pb-28 md:pb-10">
          <div className="max-w-xl mx-auto">
            <div className="mb-6 scroll-mt-28 sm:mb-8" id="booking-page-top">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <span className="inline-flex items-center gap-1.5 rounded-full border border-primary/30 bg-white px-3 py-1 text-xs font-medium text-primary dark:bg-primary/10">
            ...
            {currentStep !== 6 && (
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <div
                    className="absolute left-[10%] top-4 h-0.5 bg-primary transition-[width] duration-200 ease-out"
                          ...
                          <button
                            ...
                            className={`relative z-[1] flex h-8 w-8 items-center justify-center rounded-full border text-xs transition-colors duration-200 ${
                              isActive
                                ...
                                : isCompleted
                                  ? 'cursor-pointer border-primary bg-white text-primary hover:bg-primary/5 dark:bg-background'
            ...
            <div className="mx-auto flex max-w-xl justify-between gap-3">
              ...
              {currentStep < totalSteps ? (
                <Button
                  onClick={nextStep}
                  className={`flex h-11 flex-1 cursor-pointer items-center justify-center sm:flex-none ${
