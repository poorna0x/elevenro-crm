-- Fix technician authentication by adding missing fields
-- Run this script in your Supabase SQL editor

-- Add password and account_status fields to technicians table
...
-- Update existing technicians to have ACTIVE status
UPDATE technicians 
...
-- Create another sample technician
-- Password: 'tech123'
INSERT INTO technicians (
    full_name,
    phone,
...
-- Verify the changes
SELECT id, full_name, email, employee_id, account_status, 
